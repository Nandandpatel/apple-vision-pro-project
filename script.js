...
//   set start end according to preference
  start: `top top`,
  end: `600% top`,   // kaha pe tumhe end karana hai if 800% then 8 page tak chalega 
});
}
canvas();
...
var tl3 = gsap.timeline({
  scrollTrigger:{
      ...
      scrub:1,
      scroller:`#main`,
      pin:true   // pin is used to stop the pages for a while to show the effect while scrolling 
  }
})
